...
\usepackage[sorting=none,language=ngerman,style=numeric,backend=bibtex8, bibencoding=utf8] {biblatex} %[sorting=nty,language=ngerman,style=numeric,backend=bibtex8, bibencoding=utf8]
